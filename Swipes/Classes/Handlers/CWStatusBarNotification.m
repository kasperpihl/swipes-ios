...
{
    self.notificationWindow = [[UIWindow alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 20)];
    ...
    if (!self.notificationIsShowing) {
        ...
        [UIView animateWithDuration:STATUS_BAR_ANIMATION_LENGTH animations:^{
            ...
            perform_block_after_delay(delayInSeconds, ^{
                self.notificationLabel.backgroundColor = CLEAR;
